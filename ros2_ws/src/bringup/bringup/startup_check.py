    ...
    def run(self):
        if self.ret:
            ...
            if self.lang == 'Chinese':
                os.system('aplay -q -fS16_LE -r16000 -c1 -N --buffer-size=81920 ' + "/home/jetson/repos/RoboArm/ros2_ws/src/bringup/voice/Chinese/running.wav")
                self.get_logger().info('\033[1;32m%s\033[0m' % "准备就绪")
            else:
                os.system('aplay -q -fS16_LE -r16000 -c1 -N --buffer-size=81920 ' + "/home/jetson/repos/RoboArm/ros2_ws/src/bringup/voice/running.wav")
